package com.handler.fatca.utils.metadata;

import com.handler.fatca.utils.UtilShared;
import com.handler.fatca.utils.intf.IMetadata;
import com.handler.fatca.utils.senderfilemetadata.*;
...
public class FATCAMetadata implements IMetadata {
	...
	public FATCAMetadata() {
		try {
			jaxbCtxMetadata = JAXBContext.newInstance("com.handler.fatca.utils.senderfilemetadata");
		} catch(Throwable t) {
			t.printStackTrace();
...
<xsd:element ref="SenderContactEmailAddressTxt" minOccurs="0"/>
	...
	public String createMetadata(String folder, String senderGiin, String receiverGiin, String commType,
		...
		log.debug("--> createMetadata(). senderGiin=" + senderGiin + ", receiverGiin=" + receiverGiin + ", taxyear=" + taxyear +
